...
namespace criptografia_csharp
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(new frmCriptografiaOpenSSL());
        }
        ...
        private static void testeCriptografarArquivos(string password = "")
        {
            ...
            System.Console.WriteLine("-- an�lise linha a linha");

            string[] linhas1 = File.ReadAllLines(arquivoEntrada);
            string[] linhas2 = File.ReadAllLines(arquivoDecript);

            bool ok = true;
            if (linhas1.Length != linhas2.Length) { System.Console.WriteLine("ind�cio de erro"); }
            ...
            for (int i = 0; i < nlines; i++)
            {
                ...
                {
                    ok = false;
                    System.Console.WriteLine("Diverg�ncia '{0}'", l1.Replace(l2, ""));
                }
            }
